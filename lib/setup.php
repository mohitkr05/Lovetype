...
function lovetype_scripts() {
    ...
    wp_enqueue_script('bootstrap-js', get_template_directory_uri() .    '/inc/js/bootstrap.min.js');
    wp_enqueue_script('sc-js', get_template_directory_uri() .     '/inc/js/social-likes.min.js');
