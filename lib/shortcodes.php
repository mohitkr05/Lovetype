...
class BoostrapShortcodes {
  ...
  function bootstrap_shortcodes_scripts()  { 
    ...
    wp_enqueue_script( 'bootstrap-shortcodes-tooltip', LOVETYPE_JS . 'js/bootstrap-shortcodes-tooltip.js', array( 'jquery' ), false, true );
    
    // Bootstrap popover js
    wp_enqueue_script( 'bootstrap-shortcodes-popover', LOVETYPE_JS . 'js/bootstrap-shortcodes-popover.js', array( 'jquery' ), false, true );
...
function bs_popover( $atts, $content = null ) {
  ...
  /*--------------------------------------------------------------------------------------
    ...
    * Fontawesome
    *
    * @author  M. W. Delaney  (email : michael@michael-delaney.com)
    * @since 1.0
    *
    *-------------------------------------------------------------------------------------*/
